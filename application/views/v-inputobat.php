            ...
            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Input Obat</strong>
                                        <small> Form</small>
                                    </div>
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">ID Obat</label>
                                            <input value="<?php echo $kode; ?>" name="id" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Jenis Obat</label>
                                            <input  name="jenis" type="text" id="vat" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Produsen Obat</label>
                                            <input  name="produsen" type="text" id="street" class="form-control">
                                        </div>
