        ...
        <div class="page-container">
            ...
            <form action="<?php echo base_url().'index.php/pelanggan/update'; ?>" method="post">
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">NIK Pelanggan</label>
                                            <input type="hidden" name="id" value="<?php echo $u->id_pelanggan ?>">
                                            <input  name="nik" type="text" id="vat" class="form-control" value="<?php echo $u->nik_pelanggan ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Nama Pelanggan</label>
                                            <input  name="nama" type="text" id="vat" class="form-control" value="<?php echo $u->nama_pelanggan ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Alamat Pelanggan</label>
                                            <input  name="alamat" type="text" id="vat" class="form-control" value="<?php echo $u->alamat_pelanggan ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Umur Pelanggan</label>
                                            <input  name="umur" type="text" id="vat" class="form-control" value="<?php echo $u->umur_pelanggan ?>">
                                        </div>
