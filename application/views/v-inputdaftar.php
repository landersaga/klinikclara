                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">No Pendaftaran</label>
                                            <input value="<?php echo $kode; ?>" name="no" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Nama Pasien</label>
                                                    <input  name="namapas" type="text" id="city"  class="form-control">
                                                </div>
                                        <div class="form-group">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Alamat Pasien</label>
                                                    <input  name="alamatpas" type="text" id="city"  class="form-control">
                                                </div>
                                        <div class="form-group">
                                                <div class="form-group">
                      ...
                      <tbody>
                       <?php 
                         ...
                         <tr>
                           ...
                           <td>
                             <a href="?id_kasur=<?php echo $u->id_kasur ?>" class="btn btn-primary" id="idkas"><i class="fa fa-edit ">
                             </i>Get</a>
                           </td>
                         </tr>
                         <?php } ?>
