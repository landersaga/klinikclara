                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <?php echo anchor('report',"Report Data Transaksi") ?>
                                </li>
                            </ul>
                        </li>
                            </ul>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            <i class="zmdi zmdi-plus"></i><?php echo anchor('perawat/tambah','Tambah Data Perawat'); ?></button>
                         ...
                         ?>
                         <tr>
                           <td><?php echo $u->id_perawat ?></td>
                           <td><?php echo $u->nama_perawat ?></td>
                           <td><?php echo $u->alamat_perawat ?></td>
                           <td><?php echo $u->kontak_perawat ?></td>
                           <td><?php echo $u->umur_perawat ?></td>
                         </tr>
                         <tr class="tr-shadow">
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i></i><?php echo anchor('perawat/edit/'.$u->id_perawat,'Edit'); ?>
                                                        </button>
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                            <i></i><?php echo anchor('perawat/hapus/'.$u->id_perawat,'Del'); ?>
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
