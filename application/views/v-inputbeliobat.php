...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- END HEADER DESKTOP-->
            <form action="<?php echo base_url().'index.php/pembelian_obat/tambah_aksi'; ?>" method="post">
            ...
            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Input Data Pembelian Obat</strong>
                                        <small> Form</small>
                                    </div>
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">ID Pembelian</label>
                                        ...
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Obat</label>
                                            <input name="obat" type="text" id="fidpel" value="<?php if(isset($_GET['id_obat'])) echo $_GET['id_obat'] ?>" id="last-name" required="required" class="form-control col-md-7 col-xs-12">
                                            <button id="#bidpel" type="button" data-target="#modalobat"class="btn btn-primary"data-toggle="modal" href="#modalobat" namedata-target=".bs-example-modal-lg">Search Data</button>
                                        </div>
                                        <div class="form-group">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Harga</label>
                                                    <input name="harga" type="text" id="city"  class="form-control">
                                                </div>
                                            </div>
                                        <div class="form-group">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Jumlah</label>
                                                    <input  name="jumlah" type="text" id="city"  class="form-control">
                                                </div>
                                            </div>
    ...
    <div class="modal fade bs-example-modal-lg" id="modalpegawai" tabindex="-1" role="dialog" aria-hidden="true">
                      ...
                      <tbody>
                       <?php 
                         ...
                         <tr>
                           ...
                           <td>
                             <a href="?id_pelanggan=<?php echo $u->id_pelanggan ?>" class="btn btn-primary" id="idpel"><i class="fa fa-edit ">
                             </i>Get</a>
                           </td>
                         </tr>
                         <?php } ?>
                  ...
                  <div class="modal fade bs-example-modal-lg" id="modalobat" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                      ...
                      <thead>
                        <tr>
                         ...
                         <tr>
                           ...
                           <td><?php echo $u->produsen_obat ?></td>
                           <td><?php echo $u->harga_obat ?></td>
                           <td>
                             <a href="?id_obat=<?php echo $u->id_obat ?>" class="btn btn-primary" id="pilihsatu"><i class="fa fa-edit ">
                             </i>Get</a>
                           </td>
                         </tr>
                         <?php } ?>
