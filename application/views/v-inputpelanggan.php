...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- END HEADER DESKTOP-->
            <form action="<?php echo base_url().'index.php/pelanggan/tambah_aksi'; ?>" method="post">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">ID Pelanggan</label>
                                            <input value="<?php echo $kode; ?>" name="id" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">NIK Pelanggan</label>
                                            <input  name="nik" type="text" id="vat" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Nama Pelanggan</label>
                                            <input  name="nama" type="text" id="street" class="form-control">
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Alamat Pelanggan</label>
                                                    <input  name="alamat" type="text" id="city"  class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Umur Pelanggan</label>
