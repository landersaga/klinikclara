...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- END HEADER DESKTOP-->
            <form action="<?php echo base_url().'index.php/kasur/tambah_aksi'; ?>" method="post">
            ...
            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Input Kasur</strong>
                                        <small> Form</small>
                                    </div>
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">ID Kasur</label>
                                            <input value="<?php echo $kode; ?>" name="idkasur" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Status Kasur</label>
                                            <input  name="status" type="text" id="vat" class="form-control">
                                        </div>
                                        </div>
