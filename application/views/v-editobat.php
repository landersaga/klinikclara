            ...
            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Update Obat</strong>
                                        <small> Form</small>
                                    </div>
                                    <div class="card-body card-block">
                                    <?php foreach ($obat as $u) {}?>
            <form action="<?php echo base_url().'index.php/obat/update'; ?>" method="post">
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Jenis</label>
                                            <input type="hidden" name="id" value="<?php echo $u->id_obat ?>">
                                            <input  name="jenis" type="text" id="vat" class="form-control" value="<?php echo $u->jenis_obat ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Produsen</label>
                                            <input  name="produsen" type="text" id="street" class="form-control" value="<?php echo $u->produsen_obat ?>">
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Harga</label>
                                                    <input  name="harga" type="text" id="city"  class="form-control" value="<?php echo $u->harga_obat ?>">
                                                </div>
                                            </div>
