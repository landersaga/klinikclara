        ...
        <div class="page-container">
            ...
            <form action="<?php echo base_url().'index.php/dokter/update'; ?>" method="post">
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Nama Dokter : </label>
                                            <input type="hidden" name="iddok" value="<?php echo $u->id_dokter ?>">
                                            <input  name="nama" type="text" id="vat" class="form-control" value="<?php echo $u->nama_dokter ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Alamat Dokter</label>
                                            <input  name="alamat" type="text" id="street" class="form-control" value="<?php echo $u->alamat_dokter ?>">
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Umur Dokter</label>
                                                    <input  name="umur" type="text" id="city"  class="form-control" value="<?php echo $u->umur_dokter ?>">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Kontak Dokter</label>
                                                    <input  name="kontak" type="text" id="city"  class="form-control" value="<?php echo $u->kontak_dokter ?>">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="postal-code" class=" form-control-label">Spesialisasi</label>
                                                    <input  name="spesialis" type="text" id="postal-code"  class="form-control" value="<?php echo $u->spesialis ?>">
                                        </div>
                                        <button id="payment-button" value="Tambah" class="btn btn-lg btn-info btn-block">
