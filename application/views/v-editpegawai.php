        ...
        <div class="page-container">
            ...
            <form action="<?php echo base_url().'index.php/pegawai/update'; ?>" method="post">
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Nama Pegawai</label>
                                            <input type="hidden" name="id" value="<?php echo $u->id_pegawai ?>">
                                            <input  name="nama" type="text" id="vat" class="form-control" value="<?php echo $u->nama_pegawai ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Alamat Pegawai</label>
                                            <input  name="alamat" type="text" id="vat" class="form-control" value="<?php echo $u->alamat_pegawai ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Kontak Pegawai</label>
                                            <input  name="kontak" type="text" id="vat" class="form-control" value="<?php echo $u->kontak_pegawai ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Umur Pegawai</label>
                                            <input  name="umur" type="text" id="vat" class="form-control" value="<?php echo $u->umur_pegawai ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Username</label>
                                            <input  name="username" type="text" id="vat" class="form-control" value="<?php echo $u->username ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Password</label>
                                            <input  name="password" type="text" id="vat" class="form-control" value="<?php echo $u->password ?>">
                                        </div>
