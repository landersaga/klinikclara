...
<body class="animsition">
    <div class="page-wrapper">
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <?php echo anchor('resep',"Resep Obat") ?>
                                </li>
                            </ul>
                        </li>
                        <li class="active has-sub">
        ...
        <div class="page-container">
            ...
            <!-- END HEADER DESKTOP-->
            <form action="<?php echo base_url().'index.php/resep/tambah_aksi'; ?>" method="post">
            ...
            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Input Resep Obat</strong>
                                        <small> Form</small>
                                    </div>
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">ID Resep Obat</label>
                                            <input value="<?php echo $kode; ?>" name="idresep" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Dokter</label>
                                            <input value="<?php if(isset($_GET['id_dokter'])) echo $_GET['id_dokter'] ?>" name="iddok" type="text" id="last-name" required="required" class="form-control col-md-7 col-xs-12">
                                            <button type="button" data-target="#modaldokter" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">Search Data</button>
                                        </div>
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Nama Pasien</label>
                                            <input  name="nama_pasien" type="text" id="street" class="form-control">
                                        </div>
    ...
    <div class="modal fade bs-example-modal-lg" id="modaldokter" tabindex="-1" role="dialog" aria-hidden="true">
                      ...
                      <tbody>
                       <?php 
                         ...
                         <tr>
                           ...
                           <td><?php echo $u->umur_dokter ?></td>
                           <td><?php echo $u->kontak_dokter ?></td>
                           <td><?php echo $u->spesialis ?></td>
                           <td>
                             <a href="?id_dokter=<?php echo $u->id_dokter ?>" class="btn btn-primary" id="id_dokter"><i class="fa fa-edit ">
                             </i>Get</a>
                           </td>
                         </tr>
                         <?php } ?>
