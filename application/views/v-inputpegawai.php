...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- END HEADER DESKTOP-->
            <form action="<?php echo base_url().'index.php/pegawai/tambah_aksi'; ?>" method="post">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">ID Pegawai</label>
                                        ...
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Alamat Pegawai</label>
                                            <input  name="alamat" type="text" id="street" class="form-control">
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Kontak</label>
                                                    <input  name="kontak" type="text" id="city"  class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Umur</label>
                                            ...
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <input  name="password"  type="text" id="postal-code"  class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        </div>
