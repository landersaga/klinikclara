...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- END HEADER DESKTOP-->
            <form action="<?php echo base_url().'index.php/dokter/tambah_aksi'; ?>" method="post">
            ...
            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Input Dokter</strong>
                                        <small> Form</small>
                                    </div>
                                    <div class="card-body card-block">
                                        <div class="form-group">
                                            <label for="company" class=" form-control-label">ID Dokter</label>
                                            <input value="<?php echo $kode; ?>" name="iddok" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Nama Dokter</label>
                                            <input  name="nama" type="text" id="vat" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Alamat Dokter</label>
                                            <input  name="alamat" type="text" id="street" class="form-control">
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Umur Dokter</label>
                                                    <input  name="umur" type="text" id="city"  class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="city" class=" form-control-label">Kontak Dokter</label>
                                                    <input  name="kontak" type="text" id="city"  class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-8">
                                                <div class="form-group">
                                                    <label for="postal-code" class=" form-control-label">Spesialisasi</label>
                                                    <input  name="spesialis" type="text" id="postal-code"  class="form-control">
                                                </div>
                                            </div>
                                        </div>
