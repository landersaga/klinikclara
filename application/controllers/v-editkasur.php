            ...
            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Update Kasur</strong>
                                        <small> Form</small>
                                    </div>
                                    <div class="card-body card-block">
                                    <?php foreach ($kasur as $u) {}?>
            <form action="<?php echo base_url().'index.php/kasur/update'; ?>" method="post">
                                        <div class="form-group">
                                            <label for="vat" class=" form-control-label">Status</label>
                                            <input type="hidden" name="id_kasur" value="<?php echo $u->id_kasur ?>">
                                            <input  name="status" type="text" id="vat" class="form-control" value="<?php echo $u->status ?>">
                                        </div>
